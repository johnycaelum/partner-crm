...
<body style="margin:0;padding:0;background:#f0f4ff;font-family:system-ui,-apple-system,sans-serif;">
  <div style="max-width:440px;margin:40px auto;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(59,130,246,0.1);">
    <div style="background:linear-gradient(135deg,#3b82f6,#818cf8);padding:32px 24px;text-align:center;">
      <h1 style="margin:0;color:#fff;font-size:1.3rem;font-weight:800;">CBU Partner</h1>
      <p style="margin:6px 0 0;color:rgba(255,255,255,0.8);font-size:0.85rem;">cbucompany.ru</p>
    </div>
    <div style="padding:32px 28px;">
      <p style="color:#475569;font-size:0.9rem;line-height:1.6;margin:0 0 24px;">Your verification code (valid for 10 minutes):</p>
      ...
      <p style="color:#94a3b8;font-size:0.8rem;text-align:center;margin:24px 0 0;">If you didn't request this code, please ignore this email.</p>
    </div>
  </div>
</body></html>`,
        }),
